...
let cardsState = _onChangeDefault.default([], (_)=>{
    console.log(cardsState);
    _cashDomDefault.default(render());
});
function render() {
// let sortedElements = [...cellState]
// sortedElements.sort((a, b) => a.cell - b.cell)
// $("#app").html("")
// $(html).appendTo("#app")
}
function changeMode(to) {
    console.log("Changed mode from", mode, "to", to);
    mode = to;
}
function getMode() {
    return mode;
...
function interact(player) {
    ...
    switch(mode[player]){
        ...
        case "spectate":
            break;
        default:
            throw new Error("Wrong mode found.");
    }
}
window.interact = interact;
window.getMode = getMode;
window.changeMode = changeMode;
_cashDomDefault.default(init());
_cashDomDefault.default(render());

},{"cash-dom":"1st5g","on-change":"dzmLG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1st5g":[function(require,module,exports) {
...
},{}],"dzmLG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./clone-object.js":"9qeRV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kn9T2","7nZVA","8lqZg"], "8lqZg", "parcelRequire86ed")
